...
- `npmw` - wrapper to use locally installed npm.
  fixJHipster installs Node and npm locally using the build tool by default. This wrapper makes sure npm is installed locally and uses it avoiding some differences different versions can cause. By using `./npmw` instead of the traditional `npm` you can configure a Node-less environment to develop or test your application.
...
To build the final jar and optimize the easyPosFrontEnd application for production, run:
