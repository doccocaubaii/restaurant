...
@AuditTable(value = "mc_receipt_aud", schema = "audit")
...
public class McReceipt extends AbstractAuditingEntity<String> implements Serializable {
    ...
    public McReceipt date(ZonedDateTime date) {
        this.setDate(date);
        return this;
    }
    ...
    public McReceipt customerName(String customerName) {
    ...
    public McReceipt amount(BigDecimal amount) {
    ...
    public McReceipt description(String description) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof McReceipt)) {
            return false;
        }
        return id != null && id.equals(((McReceipt) o).id);
    }
