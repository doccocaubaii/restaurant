...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        vn.softdreams.easypos.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        vn.softdreams.easypos.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleDateTimeException(DateTimeException ex, NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "vn.softdreams.easypos");
    }
}
