...
import vn.softdreams.easypos.dto.MqttMessageDto;
...
import vn.softdreams.easypos.service.dto.PasswordChangeDTO;
import vn.softdreams.easypos.web.rest.errors.EmailAlreadyUsedException;
import vn.softdreams.easypos.web.rest.errors.InvalidPasswordException;
import vn.softdreams.easypos.web.rest.errors.LoginAlreadyUsedException;
import vn.softdreams.easypos.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody AdminUserDTO userDTO) {
        ...
        Optional<User> user = userRepository.findOneByUsernameActive(userLogin);
        if (!user.isPresent()) {
