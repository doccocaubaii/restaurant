...
public class DateUtil {
    ...
    public static final String C_DD_MM_YYYY_HHMMSS = "dd/MM/yyyy HH:mm:ss";
    public static final String C_YYYY_MM_DD = "yyyy-MM-dd";
    public static final String C_YYYY_DD_MM = "yyyy-dd-MM";
    public static final String DEFAULT_FROM_DATE = "1970-01-01 00:00:00";
    public static final String DEFAULT_TO_DATE = "2079-12-31 00:00:00";
