...
public final class Constants {
    ...
    public static final String SEND_MESSAGE_REGISTER_CONTENT =
        "Quy khach da dang ky tai khoan thanh cong tai ung dung EasyPos. Tai khoan va mat khau cua quy khach la: ";
    public static final String SEND_MESSAGE_REGISTER_SUBJECT = "EasyPOS - Thông tin khởi tạo tài khoản";
    public static final String SEND_MESSAGE_REGISTER_COMPANY_CONTENT =
        "Quy khach vua duoc khoi tao them don vi su dung moi. Vui long dang nhap he thong EasyPos voi thong tin cua quy khach da dang ky tu ban dau.";
    public static final String SEND_MESSAGE_REGISTER_COMPANY_SUBJECT = "EasyPOS - Thông tin khởi tạo thêm đơn vị sử dụng mới";
