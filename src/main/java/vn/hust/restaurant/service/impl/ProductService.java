...
import vn.hust.restaurant.service.dto.product.SaveProductRequest;
import vn.hust.restaurant.service.util.Common;
import vn.hust.restaurant.service.util.ImagePathConstants;
import vn.hust.restaurant.web.rest.errors.InternalServerException;

import java.util.Arrays;
import java.util.Optional;

import static vn.hust.restaurant.constants.ResultConstants.*;
import static vn.hust.restaurant.web.rest.errors.ExceptionConstants.PRODUCT_NOT_FOUND;
import static vn.hust.restaurant.web.rest.errors.ExceptionConstants.PRODUCT_NOT_FOUND_VI;
