  ...
  const M = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
    ...
    E = (e, t) => {
      const r = t.attr('style'),
        o = r ? N.parseStyle(r) : {};
      s(e.width) && (o['max-width'] = R(e.width)), s(e.height) && (o['max-height'] = R(e.height)), t.attr('style', N.serializeStyle(o));
    },
    U = ['source', 'altsource'],
    P = (e, t, r, o) => {
      let a = 0,
        ...
        u = e.windowManager.open({
          ...
          onSubmit: t => {
            ...
            ((e, t, r) => {
              var o, a;
              (t.embed =
                te(e, t) && k(r) ? G(r, { ...t, embed: '' }) : P(null !== (o = t.embed) && void 0 !== o ? o : '', t, !1, r.schema)),
            ...
            o.addNodeFilter(
              ...
              (e => t => {
                ...
                for (; o--; )
                  (r = t[o]),
                    r.parent &&
                      (r.parent.attr('data-mce-object') || (ae(r) && v(e) ? ue(r) || r.replace(le(e, r)) : ue(r) || r.replace(ne(e, r))));
              })(e)
            ),
        ...
        e.on('click keyup touchend', () => {
          ...
          e.on('ObjectResized', t => {
            ...
            if (r.getAttribute('data-mce-object')) {
              ...
              o &&
                ((o = unescape(o)),
                r.setAttribute('data-mce-html', escape(P(o, { width: String(t.width), height: String(t.height) }, !1, e.schema))));
            }
          });
      })(e),
      (e => ({
