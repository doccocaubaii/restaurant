...
!(function () {
                      ...
                      ((e, t) => {
                        ...
                        V(ea(e, '|'), e => {
                          ...
                          if (a) {
                            ...
                            if (
                              ('!' === n &&
                                ((t.attributesRequired = t.attributesRequired || []), t.attributesRequired.push(i), (e.required = !0)),
                              '-' === n)
                            )
          ...
          delete na.text_block_elements,
            ...
            V(
              ...
              ({ inline: e, name: t, cloneName: r }) => {
                if (
                  ((o[t] = o[r]), (s[t] = r), (v[t.toUpperCase()] = {}), (v[t] = {}), e || ((w[t.toUpperCase()] = {}), (w[t] = {})), !n[t])
                ) {
                  let e = n[r];
          ...
          if ((e => ke(e, 'id'))(t))
            return ((e, t) => {
              ...
              return Mt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(Nu(e, n.container()), n.offset()), r.setEnd(Nu(e, o.container()), o.offset()), { range: r, forward: _u(t) }
                );
              });
            })(n, t);
          if (Eu(t))
  ...
  const Fu = e => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
    ...
    Um = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (km(l) || l.block_expand) &&
          ((km(l) && Jo(r) && 0 !== s) || (r = Im(e, n, r, s, !0)), (km(l) && Jo(a) && i !== a.data.length) || (a = Im(e, n, a, i, !1))),
  ...
  const Jg = ['font', 'text-decoration', 'text-emphasis'],
    ...
    Fp = (e, t) =>
      !Mp(t) &&
      (((e, t) =>
        ((e, t) => vu(e.dom, t).isNone())(e, t) || ((e, t) => bu(e.dom, t).isNone())(e, t) || xp(e, t) || kp(e, t) || Ap(e, t) || Rp(e, t))(
        e,
        t
      ) ||
        Pp(e, t) ||
        ...
        () =>
          ((e, t, n, o) => {
            ...
            return Uh(n, o).bind(o =>
              bs(o)
                ? jh(e, o)
                : ((e, t, n, o, r) => gu(n, e.getBody(), r).bind(e => Uh(t, yn(e.getNode())).bind(e => (En(e, o) ? I.none() : I.some(E)))))(
                    e,
                    n,
                    t,
                    o,
    ...
    ib = e => {
      return e.length > 0 &&
        (!(n = e[e.length - 1]).firstChild ||
          (C(null == (t = n) ? void 0 : t.firstChild) && t.firstChild === t.lastChild && (e => e.data === pr || rr(e))(t.firstChild)))
        ? e.slice(0, -1)
        : e;
      var t, n;
    },
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                    c &&
                      u &&
                      (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), km(a) && Qb(e, a, 0, c));
                }
                return o;
              })(e, s, i, o, o, 0, a, n);
            },
                ...
                ? (km(s) || (wm(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Eb(e, s, n, o) && bv(e, t, o, r)) ||
                      (t.merge_with_parents && s && e.dom.getParent(s, s => !!Eb(e, s, n, o) && (bv(e, t, o, r), !0)));
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
            ...
            ? ((e, t, n) => {
                ...
                if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                  ...
                  (o && (null == s ? void 0 : s.data) === _b) ||
                    ((c = e.getDoc()), (u = Ab(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
    ...
    Iy = (function e() {
        ...
        xe = function (e) {
          (ye && ye === e) ||
            ...
            e.CUSTOM_ELEMENT_HANDLING &&
              ...
              (q.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
      ...
      var Re = function (e) {
        ...
        Be = function (e) {
          return 'object' === zv(i)
            ? e instanceof i
            : e && 'object' === zv(e) && 'number' == typeof e.nodeType && 'string' == typeof e.nodeName;
        },
        De = function (e, t, o) {
          O[e] &&
            oy(O[e], function (e) {
        ...
        Pe = function (e) {
          ...
          return e instanceof l &&
            ...
            ? (X &&
                ...
                (t = ly(t, D, ' ')),
                (t = ly(t, P, ' ')),
                e.textContent !== t && (sy(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !H(Hy, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o)
              : /^data:/i.test(o))))
      );
    };
  class qy {
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      const t = i.next;
                      g(o, i)
                        ? (l || ((l = new Fg(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i))
                        : (d(l), (l = null)),
                        (i = t);
                    }
                    d(l);
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            ...
            return (
              ...
              o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), RC(e, r, !0), e.setDirty(!0), e.dispatch('Undo', { level: r })),
              r
            );
          })(e, t, n, o),
        redo: (t, n) =>
          ((e, t, n) => {
            ...
            return (
              t.get() < n.length - 1 &&
                (t.set(t.get() + 1), (o = n[t.get()]), RC(e, o, !1), e.setDirty(!0), e.dispatch('Redo', { level: o })),
              o
            );
          })(e, t, n),
        clear: (t, n) =>
              ...
              .map(o =>
                gb(t)
                  ...
                  : ((e, t, n, o) => {
                      ...
                      {
                        'raw' !== o.format &&
                          (n = Xg({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
  ...
  const Aw = (e, t) => {
    ...
    Ww = [9, 27, ef.HOME, ef.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, ef.DOWN, ef.UP, ef.LEFT, ef.RIGHT].concat(
    ...
    vx = e => {
      ...
      return (
        !t.collapsed && (bx(e, !0).exists(e => e.isEqual(Li.fromRangeStart(t))) || bx(e, !1).exists(e => e.isEqual(Li.fromRangeEnd(t))))
      );
    },
  ...
  const Ek = (e, t, n, o, r, s) => {
    ...
    jk = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return (
          !!(e => w(e.selection.getSel().modify))(t) && (e && Vr(o) ? ek(!0, t.selection, o) : !(e || !Wr(o)) && ek(!1, t.selection, o))
        );
      })(e, t),
    Hk = e => {
      const t = Da(null),
    ...
    Gk = (e, t, n) => {
      if (e.selection.isCollapsed() && dd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind(e =>
              n ? e.fold(N(I.some(Xx(e))), I.none, N(I.some(Yx(e))), I.none) : e.fold(I.none, N(I.some(Yx(e))), I.none, N(I.some(Xx(e))))
            )
            .map(Wk(e, t))
            .getOrThunk(() => {
              const i = gu(n, r, o),
    ...
    mE = e =>
      G(
        ...
        e => !uE(e) && !(e => An(e).exists(uE))(e) && Jn(e, e => ar(e.dom) || ir(e.dom)).exists(e => ar(e.dom))
      ),
    fE = (e, t) => {
      var n, o;
      const { dom: r } = e,
  ...
  const AS = (e, t, n) => (e.stype === RS.Error ? t(e.serror) : n(e.svalue)),
    ...
    qS = (e, t, n, o, r) => {
      ...
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) =>
            xe(t, n).fold(
              () => ((e, t, n) => PS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + DS(n)))(e, n, t),
              o
            ))(t, n, o, s);
        case 'defaultedThunk':
    ...
    KS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === RS.Error ? { stype: RS.Error, serror: t(e.serror) } : e))(t.extract([e], n), e => ({
            input: n,
            errors: e,
          })))(e, t, n)),
        ...
        if (/^(LI|DT|DD)$/.test(r) && $o(s) && i.isEmpty(S))
          return void ((e, t, n, o, r) => {
            ...
            if (dN(n, o, !0) && dN(n, o, !1))
              ...
              aN(n, 'LI') ? (s.insertAfter(d, lN(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n)) : i.insertBefore(d, n),
                s.remove(o);
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  HE(
                    ...
                    t.preventDefault(),
                      Y_(e, 'insertText', { data: ' ' }).isDefaultPrevented() || (n(), G_(e, 'insertText', { data: ' ' }));
                  });
                })(e, t);
            });
          })(e),
  ...
  const iR = ti('mode'),
    ...
    VR = (e, t, n, o, r) => {
      ...
      const a = HR(t, wR()) || ER(n),
        i =
          !a && (e => !/<(?:\/?(?!(?:div|p|br|span)>)\w+|(?:(?!(?:span style="white-space:\s?pre;?">)|br\s?\/>))\w+\s[^>]+)>/i.test(e))(s),
        l = DR(s);
  ...
  const uA = (e, t) => Math.abs(e.left - t),
                ...
                e.execCommand('mceInsertNewLine'),
                  n.each(t => {
                    ...
                    n.data.charAt(t.offset - 1) === gr &&
                      (n.deleteData(t.offset - 1, 1), HA(e.dom, n.parentNode, t => t === e.dom.getRoot()));
                  });
              }
            ),
            !0)
    ...
    hO = e => {
      ...
      (o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline && 'static' === lO.getStyle(o, 'position', !0) && (o.style.position = 'relative'), (o.contentEditable = 'true')),
        (o.disabled = !1),
        (e.editorUpload = Bw(e)),
        (e.schema = ca(mO(e))),
        (e.dom = Oa(n, {
    ...
    IO = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Up(o, Li.fromRangeStart(t)) ? n.replace(/^ /, '&nbsp;') : n.replace(/^&nbsp;/, ' ')),
  ...
  class BT {
    ...
    show() {
      ...
      e.hidden &&
        ((e.hidden = !1),
        e.inline ? (e.getBody().contentEditable = 'true') : (AT.show(e.getContainer()), AT.hide(e.id)),
        e.load(),
        e.dispatch('show'));
    }
    hide() {
    ...
    save(e = {}) {
      ...
      const s = { ...o, content: r };
      if ((s.no_events || t.dispatch('SaveContent', s), 'raw' === s.format && t.dispatch('RawSaveContent', s), (r = s.content), Qo(n)))
        n.value = r;
      else {
  ...
  const FT = e => {
    ...
    UT = e => {
      if (e !== MT) {
        const t = Oa.DOM;
        e ? (t.bind(window, 'resize', FT), t.bind(window, 'scroll', FT)) : (t.unbind(window, 'resize', FT), t.unbind(window, 'scroll', FT)),
          (MT = e);
      }
    },
    zT = e => {
