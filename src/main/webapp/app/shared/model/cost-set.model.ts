...
export interface ICostSet {
  ...
  totalAmountExp2?: number;
  totalAmountExp3?: number;
  materialGoodsID?: string;
  costSetTypeName?: string;
}
...
export class CostSet implements ICostSet {
  constructor(
    ...
    public totalAmountExp2?: number,
    public totalAmountExp3?: number,
    public costSetTypeName?: string
  ) {
