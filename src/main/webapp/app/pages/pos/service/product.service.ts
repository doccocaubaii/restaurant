...
import { CREATE_PRODUCT, DELETE_PRODUCT, GET_PRODUCT_BY_ID, GET_PRODUCT_PAGING, UPDATE_PRODUCT } from 'app/constants/api.constants';
...
export class ProductService {
  ...
  query(req?: any): Observable<EntityArrayResponseType> {
    ...
    return this.http
      .get<RestProduct[]>(`${this.resourceUrl}${GET_PRODUCT_PAGING}`, { params: options, observe: 'response' })
