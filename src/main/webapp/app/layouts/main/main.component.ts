import { Component, HostListener, Renderer2, OnInit, ViewChild, ElementRef } from '@angular/core';
...
export class MainComponent implements OnInit {
  ...
  private checkConnection() {
    // this.utilsService.ping().subscribe(
    //   res => {
    //     if (res) {
    //       this.isOnline = res.status;
    //       this.utilsService.setStatusOnline(this.isOnline);
    //     }
    //   },
    //   req => {
    //     this.isOnline = false;
