...
export class ConfigService {
  ...
  getAllPrintConfig(id: any, req?: any): Observable<any> {
  ...
  getService() {
    return this.http.get<any>(this.resourceUrl + GET_DISPLAY_CONFIG);
  }

  updateDisplaySetting(req: any) {
    return this.http.put<any>(this.resourceUrl + UPDATE_DISPLAY_CONFIG, req);
  }
}
